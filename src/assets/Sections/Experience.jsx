...
const experiences = [
  {
    ...
    duration: "2025",
    description:
      "Designed and developed a full-stack web application using Python Flask and React.js.",
  },
  {
    ...
    duration: "2025 - 2026",
    description:
      "Web Developer specializing in WordPress and e-commerce websites.",
  },
  {
    ...
    duration: "2026",
    description:
      "Built personal and client-style projects using React, Tailwind CSS, and JavaScript with a focus on responsive design and clean components.",
  },
];
  ...
  if (layout === "desktop") {
    return (
      <div className="relative flex flex-1 justify-center items-center min-w-0">
        ...
        ></motion.div>
        <motion.article
          className={`absolute ${idx % 2 === 0 ? "bottom-20" : "top-12"} 
