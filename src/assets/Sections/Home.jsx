...
const Home = () => {
  const roles = useMemo(() => ["Web Developer", "WordPress Developer","FrontEnd Developer"], []);
  ...
  return (
    <div id="home" className="w-full h-screen bg-black overflow-hidden relative">
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="relative lg:block ">
          <div
            className="absolute top-1/2 pointer-events-none -translate-y-1/2 "
            style={{
              right: "70px",
          ...
          />
          <motion.img src="avator.png" alt="" className="absolute top-1/2 -translate-y-1/2 object-contain select-none pointer-events-none hidden lg:block
"
